module.exports = function resetMail(email, encodedEmail, code) {
  const resetCheckURL = "http://localhost:3001/auth/reset/check";
  ...
  const mailOptions = {
    ...
    html: `
      <p>Hello,</p>
      <p>To reset your password, click <a href="${resetCheckURL}?mail=${encodedEmail}">here</a> or use the following code:</p>
